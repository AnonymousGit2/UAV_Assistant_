...
namespace Microsoft.MixedReality.OpenXR.BasicSample
{
    public class LocatableCamera : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //Init keywords and Cloud API communication
            ...
            //Create capture object used to take photos
        ...
        {
            //Callback for photo capture object. Initialize camera parameters
            if (text != null)
            {
        ...
        {
            //Callback for finished initialization
            if (result.success)
            {
        ...
        private void OnPhotoCaptured(PhotoCapture.PhotoCaptureResult result, PhotoCaptureFrame photoCaptureFrame)
        {
            ...
            if (result.success)
            {
                ...
                //Create object to display photo on
                //Scale Quad
                ...
                //Now start calculating image and word coordinates
        ...
        //Method for getting world coordinates given a picture on a blendedImage and the topleft point as well as the bottom right point (scaled to 0f - 1f)
        ...
        //Do a raycast from the cameraPos along the direction and return if it was successfull as well as the target hit.
                ...
                using (WWW www = new WWW(url, postData, headers))
                {
                    ...
                    if (string.IsNullOrEmpty(www.error))
                    {
                        ...
                        for (int i = 0; i < itemcount; i++)
                        {
                            ...
                            try
                            {
                                //Look if the name is already found
                                j = i;
                                ...
                                //Calculated TopLeft position of the object
                                ...
                                //Calculated BotRight position of the object
